    ...
    <div style={{ background: 'var(--bg)' }}>
      ...
      <section className="py-20" style={{ background: 'var(--bg)' }}>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Tab buttons */}
          <div className="flex gap-1 mb-0 rounded-t-lg overflow-hidden w-fit" style={{ border: '1px solid var(--border)' }}>
            {tabs.map((t, i) => (
              <button
                key={i}
      ...
      {/* SDK Features */}
      <section id="sdk" className="py-20 lg:py-28" style={{ background: 'var(--bg-alt)' }}>
      ...
      {/* Supported Languages */}
      <section className="py-16" style={{ background: 'var(--bg)', borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="py-20" style={{ background: 'var(--bg)' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card rounded-2xl p-10" style={{ border: '1px solid var(--brand)' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/developers" className="btn-primary">Read Full Docs</Link>
              <a
