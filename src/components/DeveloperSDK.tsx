...
export default function DeveloperSDK() {
  ...
  return (
    <section className="py-24 lg:py-32" style={{ background: 'var(--bg)', borderBottom: '1px solid var(--border)' }} id="developers">
          ...
          <div>
            ...
            <ul className="space-y-3 mb-8">
              {[
                ...
                <li key={item} className="flex items-center gap-3 text-sm" style={{ color: 'var(--text-body)' }}>
            ...
            <a href="/developers" className="btn-primary text-sm">
              Read Documentation
            </a>
          </div>

          {/* Right - Code window */}
          <div className="rounded-xl overflow-hidden shadow-lg" style={{ border: '1px solid var(--card-border)', background: 'var(--code-bg)' }}>
            {/* Tab bar */}
            ...
            {/* Code */}
            <div className="p-6 font-mono text-sm leading-[1.7] overflow-x-auto" style={{ color: 'var(--code-text)' }}>
